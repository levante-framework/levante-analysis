...
## Task deep-dives (1/3): scoring artifacts & engagement {.smaller}

- **Math:** Bogotá "regression to the mean" was mostly the **column-order scoring bug**, not CAT routing (Galton slope 0.19 → 0.81 once corrected; `tasks/math_eap_vs_ml`); item bank still unbalanced by sub-domain (number-line items dominate above β = 1).
...
- **Vocab:** apparent "decline" was mostly the **column-order scoring bug** (Leipzig mean T1→T2 change −0.91 → −0.00 logits once corrected; `tasks/vocab`); easy non-adaptive forms still leave high scorers with large SEs.
